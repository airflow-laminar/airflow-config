...
- Configure other extensions like:
  ...
  - [airflow-common](https://github.com/airflow-laminar/airflow-common)
  - or write your own pydantic-based model and get yaml-based configuration for free

## The airflow-laminar Ecosystem

`airflow-config` is the configuration backbone of the [airflow-laminar](https://github.com/airflow-laminar) ecosystem:

| Library                                                                     | Description                                                                                                                                        |
| --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| [airflow-pydantic](https://github.com/airflow-laminar/airflow-pydantic)     | **Foundation library** - Pydantic models for all Airflow constructs (DAGs, Operators, Sensors). Powers the `_target_` declarations in YAML configs |
| [airflow-balancer](https://github.com/airflow-laminar/airflow-balancer)     | Host and port management - Track infrastructure, create pools automatically, select hosts by queue/OS/tags                                         |
| [airflow-supervisor](https://github.com/airflow-laminar/airflow-supervisor) | Long-running jobs - Run always-on processes with supervisord, integrated with airflow-balancer for host selection                                  |
| [airflow-common](https://github.com/airflow-laminar/airflow-common)         | Common operators - Skip/Fail/Pass operators, topology helpers, library management tasks                                                            |
| [airflow-priority](https://github.com/airflow-laminar/airflow-priority)     | Priority tracking - Track and manage DAG priorities across your Airflow deployment                                                                 |
...
`airflow-config` is similar to [dag-factory](https://github.com/astronomer/dag-factory), but with additional benefits:
...
- **Pydantic Validation**: Type-safe validation via [airflow-pydantic](https://github.com/airflow-laminar/airflow-pydantic)
