...
#### generate_in_mem(dir: Path | str = None, placeholder_dag_id: str = 'airflow-config-generate-dags')

#### generate(dir: Path | str = None)
...
### airflow_config.dag.create_dags(configs: list, dag_ids: list[str] = None, \*\*kwargs: Any) → list[[DAG](#airflow_config.dag.DAG)]

### airflow_config.dag.create_dags(config_dir: str = 'config', config_names: list[list[str]] = None, overrides: list[str] | None = None, dag_id_base: str = '', \*\*kwargs: Any) → list[[DAG](#airflow_config.dag.DAG)]
